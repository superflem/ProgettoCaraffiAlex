...
/**
 * Classe che estende una JTable e costruisce una tabella per l'utente admin.
 * @author Alex Caraffi
 */
public class TabellaAdmin extends JTable
{
	private static final long serialVersionUID = 12L;
	private ModelloTabellaAdmin modello;
	
	/**
	 * Costruttore della tabella. 
	 * Inizializzo il modello della tabella.
	 * @param mt modello tabella admin
	 */
	public TabellaAdmin (ModelloTabellaAdmin mt)
	{
		super(mt);
		modello = mt;
	}
